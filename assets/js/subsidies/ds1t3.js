...
document.getElementById('ds1t3-form').addEventListener('submit', async (event) => {
    ...
    let subsidy;
    if (location === 'north') {
        subsidy = propertyValue <= 1200 ? 500 : 500 - ((propertyValue - 1200) * (300 / 800));
    } else if (location === 'south') {
        subsidy = propertyValue <= 1200 ? 550 : 550 - ((propertyValue - 1200) * (300 / 800));
    } else {
        subsidy = propertyValue <= 1200 ? 400 : 400 - ((propertyValue - 1200) * (300 / 800));
    }
